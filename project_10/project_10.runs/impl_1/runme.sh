...
HD_PWD='D:/project_10/project_10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log two_bit_multiplier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source two_bit_multiplier.tcl -notrace

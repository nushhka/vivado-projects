...
HD_PWD='D:/project_10/project_10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log two_bit_multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source two_bit_multiplier.tcl

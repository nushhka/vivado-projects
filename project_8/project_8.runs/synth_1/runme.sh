...
HD_PWD='D:/project_8/project_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_encoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source priority_encoder.tcl

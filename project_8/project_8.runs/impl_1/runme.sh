...
HD_PWD='D:/project_8/project_8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_encoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source priority_encoder.tcl -notrace

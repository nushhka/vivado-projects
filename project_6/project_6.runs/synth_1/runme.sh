...
HD_PWD='D:/project_6/project_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_4x16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder_4x16.tcl

...
HD_PWD='D:/project_6/project_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_4x16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoder_4x16.tcl -notrace

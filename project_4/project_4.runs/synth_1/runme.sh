...
HD_PWD='D:/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fourbitadd_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fourbitadd_display.tcl

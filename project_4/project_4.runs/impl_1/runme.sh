...
HD_PWD='D:/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fourbitadd_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fourbitadd_display.tcl -notrace

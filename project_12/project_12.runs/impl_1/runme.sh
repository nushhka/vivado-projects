...
HD_PWD='D:/project_12/project_12.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log serialadder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source serialadder.tcl -notrace

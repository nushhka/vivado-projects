...
HD_PWD='D:/project_12/project_12.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log serialadder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source serialadder.tcl
